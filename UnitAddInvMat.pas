...
ADOStoredProc1.Parameters.Items[1].Value := ADOQuery1.FieldByName('ИД_ТИПА_МАТЕРИАЛА').AsInteger;
...
ADOStoredProc1.Parameters.Items[3].Value := ADOQuery2.FieldByName('ИД_ПОМЕЩЕЩЕНИЯ').AsInteger;
...
Try
  ...
  Close;
  Application.MessageBox('Полученный материал зафиксирован', 'Транзакция выполнена', MB_OK or MB_ICONINFORMATION);
