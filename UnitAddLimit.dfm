object Form26: TForm26
  Left = 0
  Top = 0
  Caption = #1057#1059#1080#1050' '#1071#1052' - '#1055#1088#1077#1076#1077#1083#1099' - '#1044#1086#1073#1072#1074#1083#1077#1085#1080#1077
  ClientHeight = 127
  ClientWidth = 269
  Color = clBtnFace
  ...
  object ADOStoredProc1: TADOStoredProc
    Connection = Form1.ADOConnection1
    ProcedureName = 'MASS_19.'#1057#1059#1048#1050'_'#1071#1052'.'#1044#1054#1041#1040#1042#1048#1058#1068'_'#1055#1056#1045#1044#1045#1051
    Parameters = <>
    Prepared = True
    Left = 64
    Top = 88
