...
procedure TForm26.Action1Execute(Sender: TObject);
begin
  Button1Click(Sender);
end;
...
if  DBEdit1.Text = '' then  begin
    Application.MessageBox('Укажите тип материала!', 'Ошибка', MB_OK or MB_ICONERROR);
    Exit;
end;
ADOStoredProc1.Parameters.Items[1].Value := ADOQueryTypesMaterial.FieldByName('ИД_ТИПА_МАТЕРИАЛА').AsString;

if  Edit1.Text = '' then  begin
    Application.MessageBox('Укажите количество у.е.!', 'Ошибка', MB_OK or MB_ICONERROR);
    Exit;
end;
