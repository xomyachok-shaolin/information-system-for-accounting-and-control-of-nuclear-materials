...
if  Edit1.Text = '' then  begin
    Application.MessageBox('¬ведите код чертежа контейнера!', 'ќшибка', MB_OK or MB_ICONERROR);
    Exit;
end;
ADOStoredProc1.Parameters.Items[0].Value := Edit1.Text;
if  Edit2.Text = '' then begin
    Application.MessageBox('¬ведите массу контейнера!', 'ќшибка', MB_OK or MB_ICONERROR);
    Exit;
end;
ADOStoredProc1.Parameters.Items[1].Value := Edit2.Text;
if  Edit3.Text = '' then begin
    Application.MessageBox('¬ведите ширину контейнера!', 'ќшибка', MB_OK or MB_ICONERROR);
    Exit;
end;
ADOStoredProc1.Parameters.Items[2].Value := Edit3.Text;
if  Edit5.Text = '' then begin
    Application.MessageBox('¬ведите длину контейнера!', 'ќшибка', MB_OK or MB_ICONERROR);
    Exit;
end;
ADOStoredProc1.Parameters.Items[3].Value := Edit5.Text;
if  Edit4.Text = '' then begin
    Application.MessageBox('¬ведите высоту контейнера!', 'ќшибка', MB_OK or MB_ICONERROR);
    Exit;
end;
