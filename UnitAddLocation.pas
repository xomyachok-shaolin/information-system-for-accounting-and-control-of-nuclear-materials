...
begin
  ...
  begin
    close;
    SQL.Clear;
    SQL.Add('select * from кадры where "Работающий"='+QuotedStr('y')+' and '+
    'ПРАВО_ОТВЕТСТВ_ПОМЕЩЕНИЯ = '+QuotedStr('y'));
    open;
  end;
