...
begin
  ...
  begin
    close;
    SQL.Clear;
    SQL.Add('select * from Тип_контейнера where ИД_типа_контейнера like'+h2);
    Open;
  end;
  Form12.ShowModal;
  DBGrid2.SetFocus;
...
if DBGrid2.SelectedRows.Count > 0 then
    begin
      case MessageBox(Form10.Handle,'Удалить запись?',
    ...
    begin
      ...
      MessageBox(Form10.Handle,'Выберите запись!',
...
begin
  ...
  begin
    close;
    SQL.Clear;
    SQL.Add('select * from Тип_контейнера where Номер_чертежа like'+help2+
                                              ' or Масса_контейнера like'+help2+
                                              ' or Ширина like'+help2+
                                              ' or Длина like'+help2+
                                              ' or Высота like'+help2);
    Open;
  end;
