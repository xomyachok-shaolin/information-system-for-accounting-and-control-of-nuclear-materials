object Form25: TForm25
  Left = 0
  Top = 0
  Caption = #1057#1059#1080#1050' '#1071#1052' - '#1052#1077#1089#1090#1086#1087#1086#1083#1086#1078#1077#1085#1080#1077' - '#1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1085#1080#1077
  ClientHeight = 184
  ClientWidth = 330
  Color = clBtnFace
  ...
  object ADOStoredProc1: TADOStoredProc
    Connection = Form1.ADOConnection1
    ProcedureName = 'MASS_19.'#1057#1059#1048#1050'_'#1071#1052'.'#1056#1045#1044#1040#1050#1058#1048#1056#1054#1042#1040#1058#1068'_'#1052#1045#1057#1058#1054#1055#1054#1051#1054#1046#1045#1053#1048#1045
    Parameters = <>
    Prepared = True
    Left = 80
    Top = 144
